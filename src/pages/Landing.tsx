                  ...
                  <div className="bg-black rounded-[46px] p-16 overflow-hidden">
                     ...
                     <div className="space-y-10 relative z-10">
                        <div className="flex justify-between items-center">
                           <span className="text-[10px] font-mono text-[#007AFF]">SCAN_SEQUENCE: INITIALIZED</span>
           ...
           <div className="container mx-auto px-6">
              <div className="grid md:grid-cols-4 gap-10">
                 {[
                    ...
                    { t: "Web Intelligence", d: "Distributed crawlers monitoring the dark & surface web." },
                    { t: "Threat Graphs", d: "Vector analysis of reputation-damaging content clusters." }
                 ].map((tech, i) => (
