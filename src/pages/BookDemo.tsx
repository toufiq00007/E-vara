    ...
    return (
      <div className="min-h-screen bg-[#050608] flex items-center justify-center p-6 text-center">
        <div className="max-w-md w-full p-12 rounded-[24px] border border-success/20 bg-success/5 backdrop-blur-xl animate-fade-in security-orange-glow">
          ...
          <h2 className="text-3xl font-black uppercase tracking-tighter mb-4">Protocol Established</h2>
          <p className="text-muted-foreground font-mono text-sm leading-relaxed mb-8">
            Your intelligence briefing has been queued. An operative will contact you within 2 business hours to establish secure communications.
          </p>
          <Link to="/">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center max-w-6xl mx-auto">
          ...
          <div>
            ...
            <p className="text-xl text-muted-foreground mb-12 font-body leading-relaxed max-w-lg">
              Schedule a technical demonstration of the E-Vara Identity Defense Engine. See how we protect high-value targets in real-time.
            </p>

            <div className="space-y-8">
              {[
                { icon: <Clock className="text-secondary" />, title: "30-Minute Briefing", desc: "A tailored walkthrough of your current threat surface." },
                { icon: <Users className="text-secondary" />, title: "Executive Consultation", desc: "Strategy session for high-net-worth identity protection." },
                { icon: <ShieldCheck className="text-secondary" />, title: "Full System Audit", desc: "Live demonstration of our automated PDF dossier generation." }
              ].map((item, i) => (
                <div key={i} className="flex gap-6">
                  ...
                  <div>
                    <h4 className="font-bold text-lg uppercase tracking-wide">{item.title}</h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Full Designation</label>
                    <div className="relative">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Organization Details</label>
                  <div className="relative">
                ...
                >
                  {loading ? "Establishing Link..." : "Initialize Briefing Request"} <ChevronRight className="ml-2 h-4 w-4" />
                </Button>

                <p className="text-[9px] text-center text-muted-foreground uppercase tracking-widest leading-relaxed">
                  By submitting, you agree to establish secure identity monitoring protocols and encrypted data exchange.
                </p>
              </form>
            </div>
          </div>
